...
statslib_inline double dlogis(const double x);
statslib_inline double dlogis(const double x, const bool log_form);
statslib_inline double dlogis(const double x, const double mu_par, const double sigma_par);
