...
statslib_inline double dunif(const double x);
statslib_inline double dunif(const double x, const bool log_form);
statslib_inline double dunif(const double x, const double a_par, const double b_par);
