...
// single input
double qnorm_int(double p, double* mu_inp, double* sigma_inp, bool log_form);
...
// vector input
arma::vec qnorm_int(const arma::vec& p, double* mu_inp, double* sigma_inp, bool log_form);
