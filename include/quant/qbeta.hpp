...
// single input
double qbeta_int(double p, double* shape_inp, double* par_2_inp, bool log_form);
...
// vector input
arma::vec qbeta_int(const arma::vec& p, double* shape_inp, double* par_2_inp, bool log_form);
