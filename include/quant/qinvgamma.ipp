                    ...
                    Tc* __stats_pointer_settings__ vals_out, const ullint_t num_elem)
{
    ...
    {
        vals_out[j] = qinvgamma(vals_in[j],shape_par,rate_par);
    }
}
...
qinvgamma(const ArmaMat<Ta>& X, const Tb shape_par, const Tb rate_par)
{
    ...
    qinvgamma_int<Ta,Tb,Tc>(X.memptr(),shape_par,rate_par,mat_out.memptr(),mat_out.n_elem);
...
qinvgamma(const EigMat<Ta,iTr,iTc>& X, const Tb shape_par, const Tb rate_par)
{
    ...
    qinvgamma_int<Ta,Tb,Tc>(X.data(),shape_par,rate_par,mat_out.data(),mat_out.size());
