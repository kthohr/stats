                 ...
                 Tc* __stats_pointer_settings__ vals_out, const ullint_t num_elem)
{
    ...
    {
        vals_out[j] = qlnorm(vals_in[j],mu_par,sigma_par);
    }
}
...
qlnorm(const ArmaMat<Ta>& X, const Tb mu_par, const Tb sigma_par)
{
    ...
    qlnorm_int<Ta,Tb,Tc>(X.memptr(),mu_par,sigma_par,mat_out.memptr(),mat_out.n_elem);
...
statslib_inline
mT
qlnorm(const ArmaGen<mT,tT>& X, const Tb mu_par, const Tb sigma_par, const bool log_form)
{
    return qlnorm(X.eval(),mu_par,sigma_par,log_form);
}
#endif
...
qlnorm(const EigMat<Ta,iTr,iTc>& X, const Tb mu_par, const Tb sigma_par)
{
    ...
    qlnorm_int<Ta,Tb,Tc>(X.data(),mu_par,sigma_par,mat_out.data(),mat_out.size());
