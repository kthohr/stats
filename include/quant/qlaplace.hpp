...
// single input
double qlaplace_int(double p, double* mu_inp, double* sigma_inp, bool log_form);
...
// vector input
arma::vec qlaplace_int(const arma::vec& p, double* mu_inp, double* sigma_inp, bool log_form);
