...
statslib_inline
void
dexp_vec(const Ta* __stats_pointer_settings__ vals_in, const Tb rate_par, const bool log_form, 
...
dexp(const ArmaMat<Ta>& X, const Tb rate_par, const bool log_form)
{
    ...
    internal::dexp_vec<Ta,Tb,Tc>(X.memptr(),rate_par,log_form,mat_out.memptr(),mat_out.n_elem);
...
dexp(const BlazeMat<Ta,To>& X, const Tb rate_par, const bool log_form)
{
    ...
    internal::dexp_vec<Ta,Tb,Tc>(X.data(),rate_par,log_form,mat_out.data(),X.rows()*X.spacing());
...
dexp(const EigMat<Ta,iTr,iTc>& X, const Tb rate_par, const bool log_form)
{
    ...
    internal::dexp_vec<Ta,Tb,Tc>(X.data(),rate_par,log_form,mat_out.data(),mat_out.size());
