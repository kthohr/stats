                  ...
                  Tc* __stats_pointer_settings__ vals_out, const ullint_t num_elem)
{
    ...
    {
        vals_out[j] = dcauchy(vals_in[j],mu_par,sigma_par,log_form);
    }
}
...
dcauchy(const ArmaMat<Ta>& X, const Tb mu_par, const Tb sigma_par, const bool log_form)
{
    ...
    dcauchy_int<Ta,Tb,Tc>(X.memptr(),mu_par,sigma_par,log_form,mat_out.memptr(),mat_out.n_elem);
...
dcauchy(const EigMat<Ta,iTr,iTc>& X, const Tb mu_par, const Tb sigma_par, const bool log_form)
{
    ...
    dcauchy_int<Ta,Tb,Tc>(X.data(),mu_par,sigma_par,log_form,mat_out.data(),mat_out.size());
