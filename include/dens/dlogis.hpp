...
statslib_constexpr
return_t<Ta> dlogis(const Ta x, const Tb mu_par, const Tb sigma_par, const bool log_form = false);
...
statslib_inline
mT dlogis(const ArmaGen<mT,tT>& X, const Tb mu_par, const Tb sigma_par, const bool log_form = false);
#endif
