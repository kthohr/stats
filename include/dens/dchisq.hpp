...
template<typename Ta, typename Tb, typename Tc = Tb>
statslib_inline
ArmaMat<Tc> dchisq(const ArmaMat<Ta>& X, const Tb dof_par, const bool log_form = false);

template<typename mT, typename tT, typename Tb>
statslib_inline
mT dchisq(const ArmaGen<mT,tT>& X, const Tb dof_par, const bool log_form = false);
#endif

#ifdef STATS_USE_BLAZE
template<typename Ta, typename Tb, typename Tc = Tb, bool To = blaze::columnMajor>
statslib_inline
BlazeMat<Tc,To> dchisq(const BlazeMat<Ta,To>& X, const Tb dof_par, const bool log_form = false);
#endif

#ifdef STATS_USE_EIGEN
template<typename Ta, typename Tb, typename Tc = Tb, int iTr = Eigen::Dynamic, int iTc = Eigen::Dynamic>
statslib_inline
EigMat<Tc,iTr,iTc> dchisq(const EigMat<Ta,iTr,iTc>& X, const Tb dof_par, const bool log_form = false);
#endif
