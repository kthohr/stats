...
template<typename T>
statslib_constexpr
T dbern(const ullint_t x, const T prob_par, const bool log_form = false);

template<typename T = double>
statslib_constexpr
T dbern(const ullint_t x);
...
statslib_inline
mT dbern(const ArmaGen<mT,tT>& X, const Tb prob_par, const bool log_form = false);
#endif
