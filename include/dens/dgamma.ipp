                 ...
                 Tc* __stats_pointer_settings__ vals_out, const ullint_t num_elem)
{
    ...
    {
        vals_out[j] = dgamma(vals_in[j],shape_par,scale_par,log_form);
    }
}
...
dgamma(const ArmaMat<Ta>& X, const Tb shape_par, const Tb scale_par, const bool log_form)
{
    ...
    dgamma_int<Ta,Tb,Tc>(X.memptr(),shape_par,scale_par,log_form,mat_out.memptr(),mat_out.n_elem);
...
dgamma(const EigMat<Ta,iTr,iTc>& X, const Tb shape_par, const Tb scale_par, const bool log_form)
{
    ...
    dgamma_int<Ta,Tb,Tc>(X.data(),shape_par,scale_par,log_form,mat_out.data(),mat_out.size());
