                ...
                Tc* __stats_pointer_settings__ vals_out, const ullint_t num_elem)
{
    ...
    {
        vals_out[j] = dbeta(vals_in[j],a_par,b_par,log_form);
    }
}
...
dbeta(const ArmaMat<Ta>& X, const Tb a_par, const Tb b_par, const bool log_form)
{
    ...
    dbeta_int<Ta,Tb,Tc>(X.memptr(),a_par,b_par,log_form,mat_out.memptr(),mat_out.n_elem);
...
dbeta(const EigMat<Ta,iTr,iTc>& X, const Tb a_par, const Tb b_par, const bool log_form)
{
    ...
    dbeta_int<Ta,Tb,Tc>(X.data(),a_par,b_par,log_form,mat_out.data(),mat_out.size());
