...
// single input
double dlaplace_int(double x, double* mu_inp, double* sigma_inp, bool log_form);
...
// vector input
arma::vec dlaplace_int(const arma::vec& x, double* mu_inp, double* sigma_inp, bool log_form);
