...
statslib_constexpr
return_t<Ta> dlaplace(const Ta x, const Tb mu_par, const Tb sigma_par, const bool log_form = false);
...
statslib_inline
mT dlaplace(const ArmaGen<mT,tT>& X, const Tb mu_par, const Tb sigma_par, const bool log_form = false);
#endif
