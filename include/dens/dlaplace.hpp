...
statslib_constexpr double dlaplace(double x);
statslib_constexpr double dlaplace(double x, const bool log_form);
statslib_constexpr double dlaplace(double x, const double mu_par, const double sigma_par);
