...
arma::Mat<Tb> rlaplace(const uint_t n, const Ta mu_par, const Ta sigma_par);

template<typename Ta, typename Tb = Ta>
arma::Mat<Tb> rlaplace(const uint_t n, const uint_t k, const Ta mu_par, const Ta sigma_par);
#endif
