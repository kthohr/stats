...
int main()
{
    ...
    double prob_1 = stats::pinvgamma(x_1,shape,rate);
    ...
    double prob_2 = stats::pinvgamma(x_2,shape,rate);
    ...
    double prob_3 = stats::pinvgamma(x_3,shape,rate);
    ...
    double prob_4 = stats::pinvgamma(x_4,shape,rate);
    ...
    double prob_5 = stats::pinvgamma(x_5,shape,rate);
    ...
    double prob_6 = stats::pinvgamma(x_6,shape,rate);
    ...
    double prob_7 = stats::pinvgamma(x_7,shape,rate);
    ...
    double prob_8 = stats::pinvgamma(x_8,shape,rate);
    ...
    double prob_9 = stats::pinvgamma(x_9,shape,rate);
