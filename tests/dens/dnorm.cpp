...
// g++-mp-7 -O3 -Wall -std=c++11 -DSTATSLIB_GO_CONST -I./../../include -I/opt/local/include dnorm.cpp -o dnorm.test -framework Accelerate
...
int main()
{
    ...
    constexpr double dens_1 = stats::dnorm(x_1,mu,sigma);
    ...
    constexpr double dens_2 = stats::dnorm(x_2,mu,sigma,true);
