...
int main()
{
    ...
    std::cout << std::setiosflags(std::ios::fixed) << std::setprecision(round_digits_2) << q_9 << ". Success = " << success_8 << std::endl;

    if (success_1 && success_2 && success_3 && success_4 && success_5 && success_6 && success_7 && success_8 && success_9) {
        std::cout << "\n*** qexp: all tests passed. ***\n" << std::endl;
    } else {
        std::cout << "\n*** qexp: some tests FAILED. ***\n" << std::endl;
    }
    ...
    stats::qexp(val_1);
    stats::qexp(val_1,true);
    stats::qexp(val_1,rate_par);
    ...
    stats::qexp(val_mat);
    stats::qexp(val_mat,true);
    stats::qexp(val_mat,rate_par);
    stats::qexp(val_mat,rate_par,true);
